...
Website: https://github.com/dfherr/LibChunt
Documentation: https://github.com/dfherr/LibChunt/wiki
Description: Tracks and communicates player and pet threat levels.
License: LGPL v2.1

Copyright (C) 2019 Dennis-Florian Herr

LibChunt incorporates work covered by the following copyright and permission notice:
...
local MAJOR, MINOR = "LibChunt", 5 -- Bump minor on changes, Major is constant lib identifier
...
local ThreatLib = LibStub("AceAddon-3.0"):GetAddon("LibChunt", true) or LibStub("AceAddon-3.0"):NewAddon("LibChunt")
...
ThreatLib.alwaysRunOnSolo = true
...
function ThreatLib:OnInitialize()
	...
	-- self.latestSeenRevision = select(2, LibStub("LibChunt"))
...
-- :IsActive()
-- Returns:
--   boolean - whether LibChunt is currently activated.
------------------------------------------------------------------------
